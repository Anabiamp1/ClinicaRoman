...
const proceduresData: Record<string, {
  ...
  "fios-de-pdo": {
    ...
    description: "Os fios de PDO (Polidioxanona) são fios absorvíveis inseridos na pele para promover sustentação e reposicionamento dos tecidos faciais. O procedimento oferece um efeito lifting imediato e, ao longo do tempo, estimula a produção de colágeno, melhorando a qualidade da pele.",
    benefits: ["Efeito lifting imediato", "Estímulo de colágeno a longo prazo", "Sem cicatrizes", "Resultados naturais e harmoniosos"],
    duration: "30 a 60 minutos",
    recovery: "3 a 7 dias",
  },
  skinbooster: {
